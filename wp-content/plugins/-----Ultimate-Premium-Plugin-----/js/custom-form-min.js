...
window.onload = function() { 
	...
	if('function' === typeof prev_onload){
	    ...
	    if(true!=(window.sfsi_premium_custom_form_initiated)){
	    	// console.log("window.sfsi_premium_custom_form_initiated",window.sfsi_premium_custom_form_initiated,'custom-form');
	    	Custom.init();
		}
